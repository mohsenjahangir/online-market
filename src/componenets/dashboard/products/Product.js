...
import '../../../componenets/dashboard/products/carsouel.css'
export const Product = () => {
  ...
  return (
    <>
    <div class=" justify-content" ><div className=" p-2 "><Carsouel/></div></div>
    
    <hr/>
      <div className=' text-capitalize m-2'>
          ...
          {products.map((item) =>
            <div className="col" key={item.id}>
              <div className="card h-100">
                <div className="bg-image hover-overlay hover-zoom hover-shadow ripple"><img className='card-img-top' key={item.id} src="https://mdbcdn.b-cdn.net/img/new/fluid/city/113.webp" />
